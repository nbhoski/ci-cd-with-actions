## Badge
[![React App CI](https://github.com/nbhoski/ci-cd-with-actions/actions/workflows/ci.yml/badge.svg)](https://github.com/nbhoski/ci-cd-with-actions/actions/workflows/ci.yml)
